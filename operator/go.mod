...
require (
	...
	github.com/kai-scheduler/KAI-scheduler v0.17.0
...
replace (
	...
	// KAI v0.17.0 requires v0.36.2 but replaces it with v0.35.4 internally.
	// Dependency replacements are not inherited; keep Grove's Kubernetes line.
